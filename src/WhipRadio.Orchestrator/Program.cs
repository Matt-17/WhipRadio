...
builder.Services.AddScoped<ConversationDirector>();
builder.Services.AddSingleton<WhipRadio.Core.Conversations.ITurnTakingPolicy,
...
builder.Services.AddScoped<GuestProfileWriter>();
builder.Services.AddScoped<GuestCreationService>();
builder.Services.AddScoped<SpecialistHostCreationService>();
builder.Services.AddScoped<AnnouncementFactory>();
builder.Services.AddScoped<ChatService>();
builder.Services.AddScoped<ChatResponderResolver>();
...
builder.Services.AddSingleton<INotificationBus, ChatNotificationBus>();
builder.Services.AddSingleton<ArtistCreationQueue>();
builder.Services.AddSingleton<ArtistMemberVoiceQueue>();
builder.Services.AddSingleton<GuestCreationQueue>();
builder.Services.AddSingleton<GuestVoiceQueue>();
...
builder.Services.AddSingleton<ParticipantMemoryWriter>();
builder.Services.AddSingleton<ParticipantMemoryRetriever>();
...
builder.Services.AddHostedService<GuestVoicePreparationService>();
...
builder.Services.AddHostedService<ChatAgentWorker>();
